...
class ArticleTile extends StatefulWidget {
  ...
  final Future<void> Function(String title)? onArticleOpen;
  const ArticleTile({super.key, required this.article, required this.primaryColor, this.onArticleOpen});
...
class _ArticleTileState extends State<ArticleTile> {
  ...
  Widget _faMiniArrow(FaIconData i, VoidCallback o) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: FaIcon(i, size: 10, color: Colors.white)
      )
    );
  }
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Row(children: [
              const CircleAvatar(radius: 14, backgroundColor: AppColors.appSurface, child: FaIcon(FontAwesomeIcons.user, size: 12, color: Colors.white24)),
            ...
            child: ClipRRect(
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(bottom: 12, left: 0, right: 0, child: Row(mainAxisAlignment: MainAxisAlignment.center, children: List.generate(2, (index) => Padding(padding: const EdgeInsets.symmetric(horizontal: 2), child: FaIcon(FontAwesomeIcons.circle, size: 6, color: _currentIndex == index ? Colors.white : Colors.white24))))),
                  ...
                  if (width > 500) ...[
                    if (_currentIndex == 1)
                      Positioned(
                        ...
                        child: Center(
                          child: _faMiniArrow(FontAwesomeIcons.chevronLeft, () {
                    ...
                    if (_currentIndex == 0)
                      Positioned(
                        ...
                        child: Center(
                          child: _faMiniArrow(FontAwesomeIcons.chevronRight, () {
                            if (_tileController.hasClients) {
  ...
  Widget _buildMainSlide() {
    return InkWell(
      onTap: () async {
        await widget.onArticleOpen?.call(widget.article.title);
            ...
            if (_finalThumbnail != null && _finalThumbnail!.isNotEmpty)
              Positioned.fill(
                child: CachedNetworkImage(
                  ...
                  fit: BoxFit.cover,
                  errorWidget: (context, url, error) => const Center(child: FaIcon(FontAwesomeIcons.satelliteDish, color: Colors.white10)),
                ),
              ),
  ...
  Widget _buildInfoSlide(String fullDesc) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const FaIcon(FontAwesomeIcons.circleInfo, color: Colors.white, size: 18),
          ...
          SizedBox(width: double.infinity, child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(backgroundColor: Colors.white, foregroundColor: Colors.black, shape: const RoundedRectangleBorder(borderRadius: BorderRadius.zero), elevation: 0, padding: const EdgeInsets.symmetric(vertical: 18)),
  ...
  Widget _buildCaption(String snippet) {
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(AppUtils.formatRelativeDate(widget.article.parsedDate).toUpperCase(), style: const TextStyle(fontSize: 8, color: AppColors.textSubtle, fontWeight: FontWeight.bold)),
